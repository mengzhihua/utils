...
| HTTP / CRC | `HttpAgeUtil` / `WarningUtil` / `HashUtil.crc16Modbus` | RFC 9111 / 7234 / MODBUS | `Age: 3600`、`110 - "Response is Stale"`、`4b37` |
