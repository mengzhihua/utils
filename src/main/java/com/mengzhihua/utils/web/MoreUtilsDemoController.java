...
import com.mengzhihua.utils.util.Base58Util;
import com.mengzhihua.utils.util.HashidsUtil;
import com.mengzhihua.utils.util.ImeiUtil;
import com.mengzhihua.utils.util.MathUtil;
import com.mengzhihua.utils.util.ReUtil;
import com.mengzhihua.utils.util.RomanUtil;
import com.mengzhihua.utils.util.SeqUtil;
import com.mengzhihua.utils.util.TextDiffUtil;
import com.mengzhihua.utils.util.UnitConvertUtil;
import com.mengzhihua.utils.util.UrlBuilder;
import com.mengzhihua.utils.util.UrlUtil;
import com.mengzhihua.utils.util.WeekUtil;
...
public class MoreUtilsDemoController {
    ...
    public Result<Map<String, Object>> consistent(
        ...
        var ring = com.mengzhihua.utils.util.ConsistentHashUtil.of(List.of("node-a", "node-b", "node-c"));
        Map<String, Object> data = new LinkedHashMap<>();
